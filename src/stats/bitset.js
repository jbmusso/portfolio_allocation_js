...
function BitSet_(arr) {
  ...
  this.words =
    typeof Uint32Array === 'function' ? new Uint32Array(0) : new Array(0);
  ...
  if (
    ...
    (typeof Uint32Array === 'function' && arr instanceof Uint32Array)
  ) {
    fromArray(arr);
  }
  ...
  this.iterator = function () {
    ...
    this.next = function () {
      ...
      var t = this.w & -this.w;
      var value =
        (this.w_idx << that.WORD_LOG) + BitSet_.populationCount((t - 1) | 0);
      this.w ^= t;
...
BitSet_.prototype = {
  ...
  toString: function () {
    ...
    for (var i = 0; i < c; ++i) {
      ...
      // already built.
      fullStr +=
        str.length >= this.WORD_LENGTH
          ? str
          : new Array(this.WORD_LENGTH - str.length + 1).join('0') + str;
    }
  ...
  toArray: function () {
    ...
    for (var i = 0; i < c; ++i) {
      ...
      while (w != 0) {
        var t = w & -w;
        arr[pos++] =
          (i << this.WORD_LOG) + BitSet_.populationCount((t - 1) | 0);
        w ^= t;
      }
    }
